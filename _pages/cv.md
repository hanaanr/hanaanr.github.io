...
Current Training
======
* Penetration Testing, RedTeam Hacker Academy (remote) | September 2025 – present  
...
<div style="margin-bottom: 20px;">
  ...
  <p style="margin: 8px 0;">
    ...
    <span style="background-color:#E8F5E9; color:#2E7D32; padding:4px 10px; border-radius:4px; font-size:0.9em; margin-right:6px;">Data Analysis</span>
    <span style="background-color:#FFF3E0; color:#E65100; padding:4px 10px; border-radius:4px; font-size:0.9em;">Data for Policy</span>
  </p>
</div>
...
<div style="margin-bottom: 20px;">
  ...
  <p style="margin: 8px 0;">
    <span style="background-color:#FCE4EC; color:#C2185B; padding:4px 10px; border-radius:4px; font-size:0.9em; margin-right:6px;">Applied Machine Learning</span>
...
<div style="margin-bottom: 20px;">
  ...
  <p style="margin: 8px 0;">
    <span style="background-color:#E8F5E9; color:#2E7D32; padding:4px 10px; border-radius:4px; font-size:0.9em; margin-right:6px;">Team Management</span>
...
* Data Science: Python, statistics, dashboards/visualization
